...
using LibraryDemo.Authentication.TwoFactor;
using LibraryDemo.Chat;
using LibraryDemo.Configuration;
using LibraryDemo.EntityFrameworkCore;
using LibraryDemo.Startup;
using LibraryDemo.Web.Authentication.JwtBearer;
using LibraryDemo.Web.Authentication.TwoFactor;
using LibraryDemo.Web.Chat.SignalR;
using LibraryDemo.Web.Common;
using LibraryDemo.Web.Configuration;
using LibraryDemo.Web.DashboardCustomization;

namespace LibraryDemo.Web
{
    [DependsOn(
    ...
    public class LibraryDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public LibraryDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(LibraryDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LibraryDemoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(LibraryDemoWebCoreModule).Assembly);
        }
