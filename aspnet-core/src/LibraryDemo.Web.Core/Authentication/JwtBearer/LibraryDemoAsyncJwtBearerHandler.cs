...
{
    public class LibraryDemoAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public LibraryDemoAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
