...
using Acme.PhoneBookDemo.Commands;
...
using Acme.PhoneBookDemo.ApiClient;
using Acme.PhoneBookDemo.Controls;
using Acme.PhoneBookDemo.Dto;
using Acme.PhoneBookDemo.Extensions;
using Acme.PhoneBookDemo.Localization;
using Acme.PhoneBookDemo.UI;
using Acme.PhoneBookDemo.UI.Assets;
using Acme.PhoneBookDemo.Views;
using DependencyResolver = Acme.PhoneBookDemo.Core.Dependency.DependencyResolver;
