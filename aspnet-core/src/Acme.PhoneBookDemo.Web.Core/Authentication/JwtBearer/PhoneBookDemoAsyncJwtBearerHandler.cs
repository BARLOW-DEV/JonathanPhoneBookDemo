...
{
    public class PhoneBookDemoAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public PhoneBookDemoAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
