...
using Acme.PhoneBookDemo.Authentication.TwoFactor;
...
using Acme.PhoneBookDemo.Web.Authentication.JwtBearer;
using Acme.PhoneBookDemo.Web.Authentication.TwoFactor;
using Acme.PhoneBookDemo.Web.Chat.SignalR;
using Acme.PhoneBookDemo.Web.Common;
using Acme.PhoneBookDemo.Web.Configuration;
using Acme.PhoneBookDemo.Web.DashboardCustomization;

namespace Acme.PhoneBookDemo.Web
{
    [DependsOn(
    ...
    public class PhoneBookDemoWebCoreModule : AbpModule
    {
        ...
        public PhoneBookDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(PhoneBookDemoWebCoreModule).Assembly);
        }
