...
namespace LibraryDemo.Web.Public.Startup
{
    [DependsOn(
        typeof(LibraryDemoWebCoreModule)
    )]
    public class LibraryDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public LibraryDemoWebFrontEndModule(IWebHostEnvironment env, LibraryDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LibraryDemoWebFrontEndModule).GetAssembly());
        }
    }
}
