...
using LibraryDemo.Web.Public.Startup;
using LibraryDemo.Web.Session;

namespace LibraryDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : LibraryDemoViewComponent
    {
