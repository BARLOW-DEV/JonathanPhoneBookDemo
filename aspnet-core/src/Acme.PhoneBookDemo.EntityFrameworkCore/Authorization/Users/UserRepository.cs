...
{
    public class UserRepository : PhoneBookDemoRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<PhoneBookDemoDbContext> dbContextProvider)
