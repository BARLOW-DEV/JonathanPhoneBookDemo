...
using Acme.PhoneBookDemo.EntityFrameworkCore.Repositories;

namespace Acme.PhoneBookDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : PhoneBookDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<PhoneBookDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
