...
namespace Acme.PhoneBookDemo.Web.Public.Startup
{
    [DependsOn(
    ...
    public class PhoneBookDemoWebFrontEndModule : AbpModule
    {
        ...
        public PhoneBookDemoWebFrontEndModule(IWebHostEnvironment env, PhoneBookDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
