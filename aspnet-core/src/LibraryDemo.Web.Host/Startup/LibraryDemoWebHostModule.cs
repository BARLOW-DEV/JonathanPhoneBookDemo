...
using LibraryDemo.Authorization.Users.Password;
using LibraryDemo.Configuration;
using LibraryDemo.EntityFrameworkCore;
using LibraryDemo.MultiTenancy;
using LibraryDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace LibraryDemo.Web.Startup
{
    ...
    public class LibraryDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public LibraryDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LibraryDemoWebHostModule).GetAssembly());
        }
