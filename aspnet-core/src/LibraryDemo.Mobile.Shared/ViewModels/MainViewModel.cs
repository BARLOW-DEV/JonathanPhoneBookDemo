...
using LibraryDemo.Core.Threading;
using LibraryDemo.Models.NavigationMenu;
using LibraryDemo.Services.Navigation;
...
using LibraryDemo.ApiClient;
using LibraryDemo.Controls;
using LibraryDemo.Dto;
using LibraryDemo.Extensions;
using LibraryDemo.Localization;
using LibraryDemo.UI;
using LibraryDemo.UI.Assets;
using LibraryDemo.Views;
using DependencyResolver = LibraryDemo.Core.Dependency.DependencyResolver;
...
namespace LibraryDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "LibraryDemo";
