...
using Acme.PhoneBookDemo.Auditing.Exporting;
using Acme.PhoneBookDemo.Authorization;
using Acme.PhoneBookDemo.Authorization.Users;
using Acme.PhoneBookDemo.Dto;
using Acme.PhoneBookDemo.EntityHistory;
using EntityHistoryHelper = Acme.PhoneBookDemo.EntityHistory.EntityHistoryHelper;

namespace Acme.PhoneBookDemo.Auditing
{
    [DisableAuditing]
