...
using Acme.PhoneBookDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Acme.PhoneBookDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : PhoneBookDemoAppServiceBase, IDashboardCustomizationAppService
    {
