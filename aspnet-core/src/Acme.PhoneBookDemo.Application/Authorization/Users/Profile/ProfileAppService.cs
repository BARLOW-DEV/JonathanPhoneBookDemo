...
using Acme.PhoneBookDemo.Authorization.Users.Profile.Cache;
...
using Acme.PhoneBookDemo.Gdpr;
using Acme.PhoneBookDemo.Net.Sms;
using Acme.PhoneBookDemo.Security;
using Acme.PhoneBookDemo.Storage;
using Acme.PhoneBookDemo.Timing;

namespace Acme.PhoneBookDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PhoneBookDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Acme.PhoneBookDemo",
