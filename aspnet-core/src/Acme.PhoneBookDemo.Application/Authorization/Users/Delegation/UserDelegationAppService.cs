...
namespace Acme.PhoneBookDemo.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : PhoneBookDemoAppServiceBase, IUserDelegationAppService
    {
