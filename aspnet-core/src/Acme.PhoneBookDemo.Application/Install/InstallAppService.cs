...
namespace Acme.PhoneBookDemo.Install
{
    ...
    public class InstallAppService : PhoneBookDemoAppServiceBase, IInstallAppService
    {
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{PhoneBookDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{PhoneBookDemoConsts.ConnectionStringName}", constring);
        }
