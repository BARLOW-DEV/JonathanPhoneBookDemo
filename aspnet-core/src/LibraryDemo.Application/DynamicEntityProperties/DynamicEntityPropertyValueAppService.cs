...
using LibraryDemo.DynamicEntityPropertyValues.Dto;

namespace LibraryDemo.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : LibraryDemoAppServiceBase, IDynamicEntityPropertyValueAppService
    {
