...
{
    public class SessionAppService : LibraryDemoAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = LibraryDemoConsts.Currency,
                        CurrencySign = LibraryDemoConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = LibraryDemoConsts.AllowTenantsToChangeEmailSettings,
