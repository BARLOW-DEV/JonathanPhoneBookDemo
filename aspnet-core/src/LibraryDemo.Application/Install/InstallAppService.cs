...
using LibraryDemo.Migrations.Seed.Host;
...
namespace LibraryDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : LibraryDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<LibraryDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{LibraryDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{LibraryDemoConsts.ConnectionStringName}", constring);
        }
