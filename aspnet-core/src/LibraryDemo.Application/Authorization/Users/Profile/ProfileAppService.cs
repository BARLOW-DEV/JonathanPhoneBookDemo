...
using LibraryDemo.Authorization.Users.Profile.Cache;
using LibraryDemo.Authorization.Users.Profile.Dto;
using LibraryDemo.Configuration;
using LibraryDemo.Friendships;
using LibraryDemo.Gdpr;
using LibraryDemo.Net.Sms;
using LibraryDemo.Security;
using LibraryDemo.Storage;
using LibraryDemo.Timing;

namespace LibraryDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : LibraryDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("LibraryDemo",
