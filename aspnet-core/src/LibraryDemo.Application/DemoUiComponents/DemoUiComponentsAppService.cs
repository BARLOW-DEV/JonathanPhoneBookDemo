...
using LibraryDemo.DemoUiComponents.Dto;

namespace LibraryDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : LibraryDemoAppServiceBase, IDemoUiComponentsAppService
    {
