...
using Acme.PhoneBookDemo.Authorization.Ldap;
...
using Acme.PhoneBookDemo.DashboardCustomization.Definitions;
using Acme.PhoneBookDemo.Debugging;
using Acme.PhoneBookDemo.DynamicEntityProperties;
using Acme.PhoneBookDemo.Features;
...
using Acme.PhoneBookDemo.Net.Emailing;
using Acme.PhoneBookDemo.Notifications;
using Acme.PhoneBookDemo.WebHooks;
using Newtonsoft.Json;

namespace Acme.PhoneBookDemo
{
    [DependsOn(
        typeof(PhoneBookDemoCoreSharedModule),
