...
{
    public class UserRepository : LibraryDemoRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<LibraryDemoDbContext> dbContextProvider)
