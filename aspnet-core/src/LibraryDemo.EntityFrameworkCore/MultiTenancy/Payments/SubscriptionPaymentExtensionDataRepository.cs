...
using LibraryDemo.EntityFrameworkCore.Repositories;

namespace LibraryDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : LibraryDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<LibraryDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
