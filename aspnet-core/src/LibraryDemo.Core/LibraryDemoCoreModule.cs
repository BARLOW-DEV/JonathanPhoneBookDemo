...
using LibraryDemo.Authorization.Delegation;
using LibraryDemo.Authorization.Ldap;
...
using LibraryDemo.DashboardCustomization.Definitions;
using LibraryDemo.Debugging;
using LibraryDemo.DynamicEntityProperties;
using LibraryDemo.Features;
using LibraryDemo.Friendships;
using LibraryDemo.Friendships.Cache;
using LibraryDemo.Localization;
using LibraryDemo.MultiTenancy;
using LibraryDemo.Net.Emailing;
using LibraryDemo.Notifications;
using LibraryDemo.WebHooks;
using Newtonsoft.Json;

namespace LibraryDemo
{
    [DependsOn(
        typeof(LibraryDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class LibraryDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            LibraryDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = LibraryDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, LibraryDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<LibraryDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LibraryDemoCoreModule).GetAssembly());
        }
