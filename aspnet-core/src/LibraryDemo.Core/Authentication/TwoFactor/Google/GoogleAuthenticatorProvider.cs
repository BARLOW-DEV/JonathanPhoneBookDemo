...
namespace LibraryDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : LibraryDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("LibraryDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
