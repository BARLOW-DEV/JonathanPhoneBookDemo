...
{
    public class StripeGatewayManager : LibraryDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "LibraryDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + LibraryDemoConsts.Currency;
        }
