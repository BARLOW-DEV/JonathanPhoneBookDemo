...
namespace LibraryDemo.Core.Base
{
    public abstract class LibraryDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected LibraryDemoQueryBase(string fieldName,
