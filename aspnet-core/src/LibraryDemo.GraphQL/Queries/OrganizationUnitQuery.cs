...
using LibraryDemo.Core.Base;
using LibraryDemo.Core.Extensions;
using LibraryDemo.Dto;
using LibraryDemo.Types;

namespace LibraryDemo.Queries
{
    public class OrganizationUnitQuery : LibraryDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
