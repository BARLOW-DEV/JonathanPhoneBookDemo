...
using LibraryDemo.MultiTenancy.HostDashboard;
...
namespace LibraryDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(LibraryDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
